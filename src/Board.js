...
function Board({ nrows = 5, ncols = 5, chanceLightStartsOn = 0.15 }) {
  ...
  function createBoard() {
    let initialBoard = [];
    // TODO: create array-of-arrays of true/false values, DONE but need to test
  ...
  function hasWon() {
    // TODO: check the board in state to determine whether the player has won. need to test
